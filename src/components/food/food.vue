    ...
    <div v-show="showFlag" ref="food" class="food">
      <div class="food-content">
        ...
        <div class="content">
          ...
          <div class="price">
            <span class="now" @click="price">￥{{ food.price }}</span>
        ...
        <div class="rating">
          ...
          <div class="rating-wrapper">
            <ul v-show="food.ratings && food.ratings.length">
              <li v-for="(rating,index) in food.ratings" v-show="needShow(rating.rateType, rating.text)" :key="index" class="rating-item">
                <div class="user">
